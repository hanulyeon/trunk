...
/**
 * <p>activity-logging complex type에 대한 Java 클래스입니다.
 * 
 ...
 *         &lt;element name="tests" type="{http://www.tmax.co.kr/flowengine/flowgraph/activity}tests-cls" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "activity-logging", propOrder = {
    "log",
    "tests"
})
    ...
    extends ActivityMeta
{
    ...
    protected List<TestsCls> tests;
    
    public List<TestsCls> getCondition() {
        if (tests == null) {
            tests = new ArrayList<TestsCls>();
        }
        return this.tests;
    }
